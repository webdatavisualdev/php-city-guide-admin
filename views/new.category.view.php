...
<h3 class="title-pages">New Place Category</h3>
...
<div class="form-group" style="padding: 0px 10px 0px 0px;">
   ...
   <input type="text" value="" maxlength="35" placeholder="Name" name="place_category_name" class="form-control" required="">

   <label class="control-label">Thumbnail</label>
   <input name="place_category_image" class="input-file" type="file" required="">
