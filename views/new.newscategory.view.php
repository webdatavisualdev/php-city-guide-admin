...
<h3 class="title-pages">New News Category</h3>
...
<div class="form-group" style="padding: 0px 10px 0px 0px;">
   ...
   <input type="text" value="" maxlength="35" placeholder="Name" name="news_category_name" class="form-control" required="">

   <label class="control-label">Thumbnail</label>
   <input name="news_category_image" class="input-file" type="file" required="">
